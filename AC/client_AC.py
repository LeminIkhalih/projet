...
def handle_cert_local(CERT_PATH):
    if(path.exists(CERT_PATH) and path.isfile(CERT_PATH)):
        ...
        print("il n'y a pas de certificat délivré pour le client")
        return None
...
def handle_cert(certifData):
    if certifData:
        ...
        print('Il n\'y a pas des certification')
        return None
...
class CaClient:
    ...
    def generateCertRequest(self):
        ...
        # creation de requete de certification
        csr = x509.CertificateSigningRequestBuilder().subject_name(x509.Name([
            # Fournissez divers détails sur qui nous sommes
        ...
        # Écrivez notre CSR sur le disque.
    ...
    def send(self, action, data):
        ...
        print('Le client envoie la demande avec la file d\'attente '+str(self.queue_name))
